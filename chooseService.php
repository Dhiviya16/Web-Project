...
<!-- Card images for every services -->
...
<div class="col-md-4 col-sm-6">
	...
	<div class="popup-card">
		<div class="info">
			...
			<!-- Service selection -->
          <div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service1" value="Hello Aircond Service" >  
				<label for= "langs_service1"> Hello Aircond Service</label> <br>
			</div>
			<div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service2" value="Up Your Home Services">   
				<label for= "langs_service2"> Up Your Home Services</label><br> 
			</div>
			<div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service3" value="Amigo Airconds">  
				 <label for= "langs_service3"> Amigo Airconds</label> <br>
			</div>
			<br>
			<div>
