...
<div class="col-md-4 col-sm-6">
	...
	<div class="popup-card">
		<div class="info">
			...
			<br>
          <div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service1" value="Homefix" >  
				<label for= "langs_service1"> Homefix</label> <br>
			</div>
			<div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service2" value="WCM One Stop">   
				<label for= "langs_service2"> WCM One Stop</label><br> 
			</div>
			<div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service3" value="Doniry Trading">  
				 <label for= "langs_service3"> Doniry Trading</label> <br>
			</div>
			<div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service3" value="Up Your Home">  
				 <label for= "langs_service3"> Up Your Home</label> <br>
			</div>
			<br>
			<div>
