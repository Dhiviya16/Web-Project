...
<div class="col-md-4 col-sm-6">
	...
	<div class="popup-card">
		<div class="info">
			...
			<br>
          <div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service1" value="Vision Cleaning" >  
				<label for= "langs_service1"> Vision Cleaning</label> <br>
			</div>
			<div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service2" value="Magic Maid">   
				<label for= "langs_service2"> Magic Maid</label><br> 
			</div>
			<div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service3" value="Shine & Bright">  
				 <label for= "langs_service3"> Shine & Bright</label> <br>
			</div>
			<br>
			<div>
