...
<div class="col-md-4 col-sm-6">
	...
	<div class="popup-card">
		<div class="info">
			...
			<br>
          <div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service1" value="Adept Service" >  
				<label for= "langs_service1"> Adept Service</label> <br>
			</div>
			<div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service2" value="Homefix">   
				<label for= "langs_service2"> Homefix</label><br> 
			</div>
			<br>
			<div>
