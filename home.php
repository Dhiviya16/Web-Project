...
<div class="col-md-4 col-sm-6">
	...
	<div class="popup-card">
		<div class="info">
			...
			<br>
          <div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service1" value="VP Clean" >  
				<label for= "langs_service1"> VP Clean</label> <br>
			</div>
			<div>
				<input class ="single-checkbox" name = "langs[]" type="checkbox" id="langs_service2" value="Bright & Shine">   
				<label for= "langs_service2"> Bright & Shine</label><br> 
			</div>
			<br>
			<div>
